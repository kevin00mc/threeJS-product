...
class HackNSlashDemo {
  ...
  _LoadPlayer() {
    ...
    girl.SetPosition(new THREE.Vector3(100, 100, 0));
    ...
    for (let i = 0; i < 50; ++i) {
      ...
      const dino = dinos[math.rand_int(0, dinos.length - 1)];
      ...
      const d = new entity.Entity();
      d.AddComponent(new gltf_component.AnimatedModelComponent({
          scene: this._scene,
          resourcePath: './resources/dinos/',
          resourceName: dino + '.fbx',
          scale: 0.02,
          emissive: new THREE.Color(0x000000),
          specular: new THREE.Color(0x000000),
          receiveShadow: true,
